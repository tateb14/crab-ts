...
module.exports = {
  customId: "crab-modal_medical-report",
  execute: async (interaction) => {
    ...
    const medicalDescription = interaction.fields.getTextInputValue("crab-input_description")
    ...
    .setDescription(`Below are details of the medical report submitted by ${interaction.user}.`)
