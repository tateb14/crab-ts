...
module.exports = {
  customId: "crab-modal_incident-report",
  execute: async (interaction) => {
    ...
    const incidentDescription = interaction.fields.getTextInputValue("crab-input_description")
    ...
    .setDescription(`Below are details of the incident report submitted by ${interaction.user}.`)
