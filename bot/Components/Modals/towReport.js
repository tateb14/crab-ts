...
module.exports = {
  customId: "crab-modal_tow-report",
  execute: async (interaction) => {
    ...
    const towDescription = interaction.fields.getTextInputValue("crab-input_description")
    ...
    .setDescription(`Below are details of the tow report submitted by ${interaction.user}.`)
    .setTitle("Tow Report")
    ...
    const channel = await interaction.guild.channels.fetch(GuildConfig.report_Logs)
    if (channel) {
      ...
      const newReport = new GuildReport({
        ...
        ReviewedBy: null,
        Description: towDescription,
        ReportType: "Tow Report",
        id: ReportID,
