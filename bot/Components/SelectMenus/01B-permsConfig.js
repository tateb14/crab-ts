...
module.exports = {
  ...
  execute: async (interaction) => {
    ...
    const supervisorMenu = new RoleSelectMenuBuilder()
    .setCustomId('crab-sm_perms-supervisor')
    .setPlaceholder('Select the Supervisor role');
    ...
    const supervisorRow = new ActionRowBuilder().addComponents(supervisorMenu)
    ...
    interaction.update({ embeds: [ConfigEmbed], components: [staffRow, supervisorRow, hicommRow, aaRow, backRow] })
  }
}
