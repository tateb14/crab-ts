    ...
    try {
      switch (true) {
        ...
        case interaction.isAnySelectMenu():
          ...
          if (!selectMenu) {
            selectMenu = [...client.selectMenus.values()].find((sm) => interaction.customId.startsWith(sm.customId));
          }
          if (!selectMenu) {
            interaction.reply({
        ...
        case interaction.isModalSubmit():
          ...
          if (!modal) {
            modal = [...client.modals.values()].find((m) => interaction.customId.startsWith(m.customId));
          }
          if (!modal) {
            interaction.reply({
