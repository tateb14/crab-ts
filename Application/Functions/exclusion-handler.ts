...
export async function userExclusionCheckInteraction(client: Client, interaction: any) {
...
export async function guildExclusionCheckMessage(client: Client, message: Message) {
...
export async function userExclusionCheckMessage(client: Client, message: Message) {
