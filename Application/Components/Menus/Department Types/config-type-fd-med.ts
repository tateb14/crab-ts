import { EmbedBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, ActionRowBuilder, StringSelectMenuInteraction, AttachmentBuilder } from 'discord.js'
...
export default {
  ...
  execute: async (interaction: StringSelectMenuInteraction) => {
    ...
    const row = new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(fdMedSelect)
