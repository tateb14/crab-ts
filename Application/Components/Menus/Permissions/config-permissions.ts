import { EmbedBuilder, StringSelectMenuBuilder, RoleSelectMenuBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuInteraction } from 'discord.js'
...
export default {
  ...
  execute: async (interaction: StringSelectMenuInteraction) => {
    ...
    await interaction.update({ embeds: [configEmbed], components: [staffRow, hicommRow, aaRow, backRow] })
  }
}
